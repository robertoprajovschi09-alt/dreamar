...
export const NICHE_CONFIGS: Record<string, NicheDashboardConfig> = {
  ...
  hospitality: {
    checkin_section_title: "Întrebări specifice — Hotels / Hospitality",
    cards: [
      { key: "bookings", label: "Rezervări / Bookings", icon: "calendar",
        source: { kind: "impact_sum", field: "bookings" },
        hint: "Lipsă date — completează în check-in" },
      { key: "reservation_requests", label: "Cereri de rezervare", icon: "message",
        source: { kind: "impact_sum", field: "dms" },
        hint: "Lipsă date — completează în check-in" },
      { key: "room_package_interest", label: "Interes camere / pachete", icon: "star",
        list: "checkin_text", list_path: ["best_package"] },
      { key: "guest_messages", label: "Mesaje & apeluri oaspeți", icon: "phone",
        source: { kind: "impact_sum", field: "calls" } },
      { key: "best_content", label: "Conținut cu cele mai bune rezultate", icon: "flame",
        list: "top_published_posts" },
      { key: "guest_reviews", label: "Review-uri & feedback oaspeți", icon: "heart",
        list: "checkin_text", list_path: ["important_reviews"] },
      { key: "approvals", label: "Conținut de aprobat", icon: "eye", list: "approvals" },
      { key: "next_actions", label: "Recomandări AI", icon: "trend", list: "next_actions" },
    ],
    checkin_extras: [
      { kind: "choice", key: "reservation_requests_received", label: "Ai primit cereri de rezervare luna aceasta?",
        options: [
          { key: "yes_many", label: "Da, multe" },
          { key: "yes_few", label: "Da, câteva" },
          { key: "no", label: "Nu" },
          { key: "unknown", label: "Nu știu" },
        ] },
      { kind: "text", key: "promote_priority", label: "Ce vrei să promovăm prioritar (camere, pachete, spa, restaurant, evenimente, nunți, oferte sezoniere)?",
        placeholder: "ex: pachet weekend SPA, nunți 2026, oferta de Crăcion…", long: true },
      { kind: "text", key: "low_availability_periods", label: "Ai perioade cu disponibilitate mare pe care vrei să le umplem?",
        placeholder: "ex: 10–25 noiembrie, week-end-uri din ianuarie…" },
      { kind: "text", key: "target_guest_type", label: "Ce tip de oaspeți vrei să atragem?",
        placeholder: "ex: cupluri, familii cu copii, business travellers, grupuri…" },
      { kind: "text", key: "important_reviews", label: "Ai primit feedback sau review-uri importante?",
        placeholder: "ex: 5★ pe Booking pentru micul dejun, plângere despre check-in…", long: true },
      { kind: "text", key: "best_package", label: "Ce pachet, cameră sau experiență a mers cel mai bine?",
        placeholder: "ex: suita cu jacuzzi, pachetul romantic, dineul cu degustare…" },
      { kind: "text", key: "important_note", label: "Există ceva important ce trebuie să știe agenția?",
        placeholder: "ex: renovăm restaurantul, schimbăm tariful, eveniment privat pe 5…", long: true },
    ],
  },
};
